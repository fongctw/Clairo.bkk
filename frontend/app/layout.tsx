...
export const metadata: Metadata = {
  ...
  icons: {
    icon: "/clairo-logo.png",
    apple: "/clairo-logo.png",
  },
};
      ...
      <body>
        <div className="mx-auto min-h-screen max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
          <header className="mb-4 flex items-center justify-between rounded-2xl border border-white/60 bg-white/85 px-5 py-3 shadow-sm backdrop-blur">
            <Link href="/map" className="flex items-center gap-2 font-display text-xl font-semibold text-ink">
              <img src="/clairo-logo.png" alt="Clairo" className="h-20 w-20 object-contain" />
              Clairo.bkk
            </Link>
            <nav className="flex items-center gap-1">
              ...
              <Link href="/ranking" className="rounded-full px-3 py-1.5 text-sm font-semibold text-ink/60 hover:bg-mist hover:text-ink transition">
                🏆 Ranking
              </Link>
            </nav>
          </header>
